// the following long note is no longer relevant,
// but I thought it was too cool to completely remove.
...
// rest of the file kept either as a reference when writing
// LLVMFuzzerTestOneInput or actually used. Should be apparent on either stance
// depending on whether or not the code is commented out.
